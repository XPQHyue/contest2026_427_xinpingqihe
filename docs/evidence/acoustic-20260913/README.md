...
板子：立创·黄山派 SF32LB52-MOD-1-N16R8 ｜ 固件（本目录记录时）：`f47004010338c22dbe1d1d5f5235c0ad`（2,023,644 B）
> 注：后续固件继续演进（09-13 23:11 已到 `075655ee…` / 2,024,432 B，含 UTF-8 截断修复），本目录的声学结论未变化。
