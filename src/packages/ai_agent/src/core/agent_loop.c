...
/* PhyWear wrist physics workshop: allow controlling the experiment UI without
 * an LLM round trip, so it also works offline.  More specific phrases must
 * come first because the table is first-match-wins. */
